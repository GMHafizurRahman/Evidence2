...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Have an Account Please Login:");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        jLabel4.setText("New Use Create Your Account:");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Person person = LoginDao.getInstance().getPerson(userName);
        System.out.println(person);
        if (person == null || person.getId() == null || !person.getId().equals(password)) {
